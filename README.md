...
| `sample_04_noisy_rx` | **Scanned Chronic Rx** | Metformin 500mg + Lisinopril 10mg + Atorvastatin 20mg | **OCR Robustness**: Handles -1.2 degree skew angle, red verification stamp, cursive doctor signature, and faint watermark. |
